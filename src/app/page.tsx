    ...
    <>
      ...
      <section className={styles.home__container}>
        ...
        <div className={styles.container__info}>
          ...
          />
          <p>
            Наши авторизованные пользователи делятся своими лекциями, загружая
            их на нашу платформу. Учитесь в своем темпе, когда и где вам удобно.
          </p>
        </div>
        <h2 className={styles.container__title}>Домашние задания</h2>
        <div className={styles.container__info}>
          <p>
            Мы предоставляем актуальные домашние задания, чтобы помочь вам
            сдавать всё в нужные сроки. Это ваш личный дневник обучения,
            наполненный заданиями от преподавателей.
          </p>
          <Image
            src={HomeworkImage}
            alt="Homework"
